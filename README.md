...
This repository contains the code and the [final report](./docs/report.pdf) for project of the course "Computer Vision" - MSc in Artificial Intelligence Systems - University of Trento. 
